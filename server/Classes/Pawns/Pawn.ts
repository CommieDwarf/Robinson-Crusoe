...
export class Pawn implements IPawn {
  ...
  get character(): IPlayerCharacter | ISideCharacter {
    return this._character;
  }


  private readonly _draggableId: string;
  private readonly _character: IPlayerCharacter | ISideCharacter;
...
export class HelperPawn extends Pawn implements IPawnHelper {
  ...
  constructor(id: number, character: IPlayerCharacter, disposable: boolean, action: HelperAction) {
    super(id, character);
    this.action = action;
