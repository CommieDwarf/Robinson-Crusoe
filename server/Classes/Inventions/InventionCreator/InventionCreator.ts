...
import { Axe } from "./Inventions/Castaways/Axe";
import { Mast } from "./Inventions/Castaways/Mast";

export class InventionCreator implements ICreator<IInvention, INVENTION> {
