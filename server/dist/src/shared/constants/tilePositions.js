...
function getTilePositions(topStart, leftStart) {
    const tileStructures = [];
    let top = topStart;
    ...
    for (let row of mapStructure) {
        ...
        for (let hex of row) {
            if (hex) {
                tileStructures.push(Object.assign(Object.assign({}, hex), { cords: { left, top } }));
            }
            left += 16;
        }
        top += 13.5;
...
exports.tilePositions = getTilePositions(17, 22);
//# sourceMappingURL=tilePositions.js.map