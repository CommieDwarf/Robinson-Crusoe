...
export const isAdventureCardRenderData = (
	candidate: IMysteryCardRenderData | IAdventureCardRenderData
): candidate is IAdventureCardRenderData => {
	return "action" in candidate;
};
