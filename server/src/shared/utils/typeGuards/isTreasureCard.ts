import {
    ...
    ITreasureMysteryCard, ITreasureMysteryCardRenderData
...
export function isTreasureCardRenderData(candidate: IMysteryCardRenderData): candidate is ITreasureMysteryCardRenderData {
    return "uses" in candidate;
}
