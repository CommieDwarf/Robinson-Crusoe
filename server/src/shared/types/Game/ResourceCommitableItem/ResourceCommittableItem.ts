...
export interface IResourceCommittableItem<Resource>
	extends IAssignablePawnsItem {
	...
	canCommitResource: (
		...
		pawnOwned: IPawnOwner
	) => boolean;

	renderData: IResourceCommittableItemRenderData<Resource>;
}

export interface IResourceCommittableItemRenderData<Resource>
	extends IAssignablePawnsItemRenderData {
	committedResources: SingleResourceRequirement<Resource> | null;
	resourceCost: SingleResourceRequirement<Resource> | null;
