...
export interface ITile extends IAssignablePawnsItem {
	...
	setTileModifier: (modifier: keyof TileModifiers, source: string) => void;

	unsetTileModifier: (modifier: keyof TileModifiers, source: string) => void;
	clearResourceModifiers: () => void;

	canResourceActionBePerformed: (
