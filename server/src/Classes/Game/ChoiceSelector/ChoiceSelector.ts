...
import {
    ...
    Choosable,
    ChoosableObject,
    ChoosableRenderData, ChoiceSubject
} from "@shared/types/Game/ChoiceSelector/ChoiceSelector";


export class ChoiceSelector<T extends ChoosableObject> implements IChoiceSelector<T> {


    private readonly _game: IGame;
    private readonly _objects: Choosable<T>[];
    ...
    private readonly _pickSubject: ChoiceSubject;
    ...
    private getObject(id: string): Choosable<T> {
