import {Side, TileResourceInfoRenderData} from "@shared/types/Game/TileService/TileResourceService";
...
export function ResourceModifiers(props: Props) {
    return <>
        ...
        {props.resourceInfo.shortcut &&
            <Shortcut side={props.side}/>
        }
        {props.resourceInfo.modifiers.length > 0 &&
            <ResourceModifier side={props.side} resource={props.resourceInfo.resource}/>
        }
