  ...
  const form = (
    ...
    >
      ...
      <div className={styles.row}>
        <span className={styles.label}>{capitalize(t("menu.name"))}</span>
        {editAllowed ? (
          <input
            type={"text"}
      ...
      {props.mode === GAME_SETTINGS_MODE.GAME_CREATE && (
        <div className={styles.row}>
          <span className={styles.label}>{capitalize(t("menu.password"))}</span>
          <input
            type={"password"}
      ...
      <div className={styles.row}>
        <span className={styles.label}>{capitalize(t("menu.scenario"))}</span>
        {editAllowed ? (
          <select
      ...
      <div className={`${styles.row}`}>
        <span className={styles.label}>{t("gameSettings.difficulty")}</span>
        <select
          className={`${styles.input}`}
      ...
      <div className={styles.row}>
        ...
        >
          ...
          <div className={styles.difficultySetting}>
            <div className={styles.difficultyLabel}>{t("character.dog")}</div>
            <CheckBox
          ...
          <div className={styles.difficultySetting}>
            <div className={styles.difficultyLabel}>
              {capitalize(t("gameSettings.startingItems"))}
            </div>
            <select
              disabled={localSettings.difficultySettings.scaled || !editAllowed}
      ...
      <div className={styles.row}>
        <span className={styles.label}>
          {capitalize(t("gameSettings.playerAmount"))}
        </span>
        {editAllowed ? (
          <select
