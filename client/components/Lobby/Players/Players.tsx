...
export function Players(props: Props) {
	...
	const pickedCharacters = props.players.map(
		(player) => player.assignedCharacter.char
	);
				...
				{props.players.map((player) => {
					return (
						<Player
							...
							duplicatedCharacter={duplicatedCharacters.includes(
								player.assignedCharacter.char
							)}
						/>
					);
				})}
