    ...
    >
      ...
      <div className={`${styles.name} font-mono`}>
        ...
        {props.host && (
          <div className={styles.host}>
            <DynamicImage src={"/UI/misc/crown.webp"} alt={"host"} fill />
          </div>
        )}
      </div>
      ...
      <div>
        <Select
          ...
          styles={{
            control: (baseStyles: CSSProperties, state) => ({
              ...baseStyles,
              height: 20,
              maxHeight: 20,
              minHeight: 20,
          ...
          onChange={(newValue) =>
            newValue && handleColorChange(newValue.value as PLAYER_COLOR)
          }
        />
      </div>
      ...
      >
        {!props.host && <DynamicImage src={bootKickImg} alt={"bootKick"} />}
      </div>
    </div>
  );
}
