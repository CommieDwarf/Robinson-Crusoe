...
export function mapAbilities(character: CHARACTER): ABILITY[] {
    switch (character) {
        ...
        case CHARACTER.EXPLORER:
            return [ABILITY.LUCKY, ABILITY.GRANDMAS_RECIPE, ABILITY.HOOCH, ABILITY.SCROUNGER];
        case CHARACTER.CARPENTER:
            return [ABILITY.A_NEW_IDEA, ABILITY.CRAFTSMANSHIP, ABILITY.ECONOMICAL_CONSTRUCTION, ABILITY.HANDYMAN];
        case CHARACTER.SOLDIER:
            return [ABILITY.DEFENSIVE_PLAN, ABILITY.FRENZY, ABILITY.THE_HUNT, ABILITY.TRACKING];
