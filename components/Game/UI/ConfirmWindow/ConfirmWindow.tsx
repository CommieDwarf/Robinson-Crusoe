...
export function ConfirmWindow(props: Props) {
    ...
    return <Draggable bounds="parent" defaultClassNameDragging={sharedStyles.grabbing}>
        <div className={styles.container}>
            ...
            <div className={styles.text}>{confirmWindowMessages[props.name]}</div>
            <hr/>
            <div className={styles.buttonsRow}>
                <div className={`${styles.button} ${styles.accept}`} onClick={handleAccept}>Akceptuj</div>
                <div className={`${styles.button} ${styles.refuse}`} onClick={handleRefuse}>Anuluj</div>
            </div>
        </div>
    </Draggable>
}
